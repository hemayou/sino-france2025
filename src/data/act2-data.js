...
export const climateEnv = {
  ...
  images: [
    { src: `${import.meta.env.BASE_URL}images/act2/climate/temperature_hipe.png`, caption: '巴黎近年来气温急剧升高' },
    { src: `${import.meta.env.BASE_URL}images/act2/climate/high_density.png`, caption: '巴黎人口密度分布' },
    { src: `${import.meta.env.BASE_URL}images/act2/climate/adaptation.png`, caption: '巴黎2050气候适应目标' },
    { src: `${import.meta.env.BASE_URL}images/act2/climate/carte_coups_de_coeur_pietons_grand_paris_1200px.jpg`, caption: '大巴黎快线及其沿途人们步行可达的自然景观、人文遗产，以及最喜爱的地点' },
...
export const ecoQuartier = {
  ...
  images: [
    { src: `${import.meta.env.BASE_URL}images/act2/eco/eco01-维克多雨果生态街区区位图.jpeg`, caption: '维克多雨果生态街区区位图' },
    { src: `${import.meta.env.BASE_URL}images/act2/eco/eco02-地区鸟瞰图-衰败的郊区街区.jpg`, caption: '地区鸟瞰图-衰败的郊区街区' },
    { src: `${import.meta.env.BASE_URL}images/act2/eco/eco03-城市设计.jpg`, caption: '城市设计' },
    { src: `${import.meta.env.BASE_URL}images/act2/eco/eco04-公共空间整合.jpg`, caption: '公共空间整合' },
    { src: `${import.meta.env.BASE_URL}images/act2/eco/eco05-保留场地内百年大树.jpg`, caption: '保留场地内百年大树' },
    { src: `${import.meta.env.BASE_URL}images/act2/eco/eco06-保留自然地形.jpg`, caption: '保留自然地形' },
    { src: `${import.meta.env.BASE_URL}images/act2/eco/eco07-开放街区与步行网络.jpg`, caption: '开放街区与步行网络' },
    { src: `${import.meta.env.BASE_URL}images/act2/eco/eco08-在步行尺度上职住平衡与功能混合.jpg`, caption: '在步行尺度上职住平衡与功能混合' },
  ],
  levels: [
    {
      title: '四大核心价值',
...
export const architectSystem = {
  ...
  images: [
    { src: `${import.meta.env.BASE_URL}images/act2/arch/arch01-城市更新与城市设计流程（中法语境）.jpg`, caption: '城市更新与城市设计流程（中法语境）' },
    { src: `${import.meta.env.BASE_URL}images/act2/arch/arch02-城市设计四控守则.jpg`, caption: '城市设计四控守则' },
    { src: `${import.meta.env.BASE_URL}images/act2/arch/arch03-城市设计：总体性与特殊性的博弈.jpg`, caption: '城市设计：总体性与特殊性的博弈' },
    { src: `${import.meta.env.BASE_URL}images/act2/arch/arch04-从建筑首层到城市首层.jpg`, caption: '从建筑首层到城市首层' },
  ],
  levels: [
    {
      title: '制度定位',
...
export const socialHousing = {
  ...
  images: [
    ...
    { src: `${import.meta.env.BASE_URL}images/act2/housing/image129.jpeg`, caption: '紧邻德芳斯商务区的60-70年代建设的云朵大厦（艾友大厦）' },
    { src: `${import.meta.env.BASE_URL}images/act2/housing/image130.png`, caption: '70年代建设的蛇形大厦' },
    { src: `${import.meta.env.BASE_URL}images/act2/housing/image138.jpeg`, caption: '1920s年代建设的花园住区（社会住房Suresnes社区）' },
    { src: `${import.meta.env.BASE_URL}images/act2/housing/image140.jpeg`, caption: '70-80年代野兽派建筑师设计的星云社会住房项目' },
    { src: `${import.meta.env.BASE_URL}images/act2/housing/image142.jpeg`, caption: '近年来办公楼宇改建的社会住房（法国最高建筑奖）' },
    { src: `${import.meta.env.BASE_URL}images/act2/housing/image146.jpeg`, caption: '国防部大楼（历史建筑）改造的社会住房' },
    { src: `${import.meta.env.BASE_URL}images/act2/housing/image157.jpeg`, caption: '80-90年代郊区建设的纯木构社会住房社区（皮埃尔·塞马尔城的"尖角区"）' },
    { src: `${import.meta.env.BASE_URL}images/act2/housing/image161.jpeg`, caption: '皮埃尔·塞马尔城的"尖角区"公共空间' },
    { src: `${import.meta.env.BASE_URL}images/act2/housing/image159.jpeg`, caption: '波兰裔建筑师布奇科夫斯卡（青年）' },
    { src: `${import.meta.env.BASE_URL}images/act2/housing/image160.jpeg`, caption: '波兰裔建筑师布奇科夫斯卡（老年）' },
  ],
  levels: [
    {
      title: 'SRU强制配额',
